...
--changeset stepanov:20221204-3-insertChartTranscript splitStatements:;

insert into CHARTTRANSCRIPT (ID, MEDIATYPE, STRUCTUREDTEXT)
values('006PAaH11EN8Q828', 'chat', '<?xml version="1.0" encoding="UTF-8"?>' ||
                                    '<chatTranscript startAt="2022-03-05T07:09:33Z" sessionId="006PAaH11EN8Q828">' ||
                                        '<newParty userId="009662230CAD7F2B" timeShift="0" visibility="ALL" eventId="1">' ||
                                            '<userInfo personId="" userNick=" " userType="CLIENT" protocolType="FLEX" timeZoneOffset="300" clientVersion="106"/>' ||
                                            '<userData>' ||
                                               ...
                                               '<item key="appVersion" type="string">version 3.40.1, build 304001</item>' ||
                                                ...
                                                '<item key="push_notification_deviceid" type="string">' ||
                                                    'eyAfHWw5TNmmrbvw1gti3l:APAtjwjw4OLtp8mnYEIczRZSTXACVEpAKhdEos3JQBhL-c_M_Wpzyj0RnYX7AMD9wq3t2t24tWWOnKfUwvGf2hI7qpNm_7Ko' ||
                                                '</item>' ||
                                        ...
                                        '<newParty userId="009662230CAF7F2D" timeShift="2" visibility="ALL" eventId="7">' ||
                                            '<userInfo personId="" userNick=" ." userType="AGENT" protocolType="BASIC" timeZoneOffset="0" clientVersion="105"/>' ||
                                            '<userData>' ||
                                        ...
                                        '<newParty userId="009662230CC77F2E" timeShift="26" visibility="ALL" eventId="14">' ||
                                            '<userInfo personId="karaca.ar" userNick=" Karaca" userType="AGENT" protocolType="BASIC" timeZoneOffset="0" clientVersion="105"/>' ||
                                            '<userData>' ||
                                        ...
                                        '<newParty userId="009662230D617F4A" timeShift="180" visibility="ALL" eventId="98">' ||
                                            '<userInfo personId="tribuna.di" userNick=" Maybe" userType="AGENT" protocolType="BASIC" timeZoneOffset="0" clientVersion="105"/>' ||
                                            '<userData>' ||
