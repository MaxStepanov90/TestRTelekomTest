...
--changeset stepanov:20221204-4-insertChartTranscript splitStatements:;

insert into CHARTTRANSCRIPT (ID, MEDIATYPE, STRUCTUREDTEXT)
values('007PAaH11EN8Q828', 'chat', '<?xml version="1.0" encoding="UTF-8"?>' ||
                                    '<chatTranscript startAt="2022-03-05T07:09:33Z" sessionId="007PAaH11EN8Q828">' ||
